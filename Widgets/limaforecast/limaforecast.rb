...
forecast_api_key = "d319718036ef69e1724de6a181486147"

# Latitude, Longitude for location
forecast_location_lat = "40.73545"
forecast_location_long = "-84.07320"
...
SCHEDULER.every '11m', :first_in => 0 do |job|
  ...
  send_event('limaforecast', { current_temp: "#{forecast_current_temp}&deg;", current_icon: "#{forecast_current_icon}", current_desc: "#{forecast_current_desc}", next_icon: "#{forecast_next_icon}", next_desc: "#{forecast_next_desc}", later_icon: "#{forecast_later_icon}", later_desc: "#{forecast_later_desc}"})
end